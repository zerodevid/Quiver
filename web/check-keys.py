...
SKIP=re.compile(r"^[\s\d.,%$/()+\-]*$|^0x|^#|^[a-z_]+$|^(RPC|API|URL|PnL|uPnL|DPR|IL|LP|ETH|USDG|WETH|Gas|Mode|Copy|Wallet|Scout|Menu|Auto-swap|Full range|Live|Simulasi|Telegram|v3|v4)$|^https?:|^mis\.|^e\.g\.|^0x…|^~|Uniswap|lpcopy|Quiver")
